...
function load() {
	...
	bar1.add("订单管理", "未付款订单", "<c:url value='/admin/AdminOrderServlet?method=findUnpaid'/>", "body");
	bar1.add("订单管理", "已付款订单", "<c:url value='/admin/AdminOrderServlet?method=findPaid'/>", "body");
	bar1.add("订单管理", "未收货订单", "<c:url value='/admin/AdminOrderServlet?method=findUnreceive'/>", "body");
	bar1.add("订单管理", "已完成订单", "<c:url value='/admin/AdminOrderServlet?method=findSuccess'/>", "body");
